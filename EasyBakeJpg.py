...
bl_info = {
    ...
    "category": "3D View",
    "blender": (2, 80, 0),
    "author": "Bram Eulaers,Tobias Trauth",
...
class EasyBake(bpy.types.Operator):
    ...
    #11 bake all maps!
        if context.scene.bakeNormal:
            ...
            bakeimage.filepath_raw = context.scene.bakeFolder+context.scene.bakePrefix+context.scene.affixNormal+".jpg"
            bakeimage.file_format = 'JPEG'
            bakeimage.save()
        ...
        if context.scene.bakeObject:
            ...
            bakeimage.filepath_raw = context.scene.bakeFolder+context.scene.bakePrefix+context.scene.affixObject+".jpg"
            bakeimage.file_format = 'JPEG'
            bakeimage.save()
        ...
        if context.scene.bakeAO:
            ...
            bakeimage.filepath_raw = context.scene.bakeFolder+context.scene.bakePrefix+context.scene.affixAO+".jpg"
            bakeimage.file_format = 'JPEG'
            bakeimage.save()
        ...
        if context.scene.bakeColor:
            ...
            bakeimage.filepath_raw = context.scene.bakeFolder+context.scene.bakePrefix+context.scene.affixColor+".jpg"
            bakeimage.file_format = 'JPEG'
            bakeimage.save()
        ...
        if context.scene.bakeRoughness:
            ...
            bakeimage.filepath_raw = context.scene.bakeFolder+context.scene.bakePrefix+context.scene.affixRoughness+".jpg"
            bakeimage.file_format = 'JPEG'
            bakeimage.save()
        ...
        if context.scene.bakeEmission:
            ...
            bakeimage.filepath_raw = context.scene.bakeFolder+context.scene.bakePrefix+context.scene.affixEmission+".jpg"
            bakeimage.file_format = 'JPEG'
            bakeimage.save()
